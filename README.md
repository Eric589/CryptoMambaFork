...
python scripts/simulate_trade.py --config itransformer_v --split test --trade_mode smart
python scripts/simulate_trade.py --config cmamba_v --split test --trade_mode smart
python scripts/simulate_trade.py --config gru_v --split test --trade_mode smart
python scripts/simulate_trade.py --config lstm_v --split test --trade_mode smart
python scripts/simulate_trade.py --config smamba_v --split test --trade_mode smart

python scripts/simulate_trade.py --config itransformer_v --split test --trade_mode vanilla
python scripts/simulate_trade.py --config cmamba_v --split test --trade_mode vanilla
python scripts/simulate_trade.py --config gru_v --split test --trade_mode vanilla
python scripts/simulate_trade.py --config lstm_v --split test --trade_mode vanilla
python scripts/simulate_trade.py --config smamba_v --split test --trade_mode vanilla

python scripts/simulate_trade.py --config itransformer_v --split test --trade_mode smart_w_short
python scripts/simulate_trade.py --config cmamba_v --split test --trade_mode smart_w_short
python scripts/simulate_trade.py --config gru_v --split test --trade_mode smart_w_short
python scripts/simulate_trade.py --config lstm_v --split test --trade_mode smart_w_short
python scripts/simulate_trade.py --config smamba_v --split test --trade_mode smart_w_short

python3 scripts/evaluation.py --config itransformer_v --ckpt_path checkpoints/itransformer_v.ckpt
python3 scripts/evaluation.py --config cmamba_v --ckpt_path checkpoints/cmamba_v.ckpt
python3 scripts/evaluation.py --config gru_v --ckpt_path checkpoints/gru_v.ckpt
python3 scripts/evaluation.py --config lstm_v --ckpt_path checkpoints/lstm_v.ckpt
python3 scripts/evaluation.py --config smamba_v --ckpt_path checkpoints/smamba_v.ckpt
